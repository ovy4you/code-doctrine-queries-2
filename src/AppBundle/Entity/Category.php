...
class Category
{
     ...
     * Add fortuneCooky
     *
     * @param \AppBundle\Entity\FortuneCookie $fortuneCooky
     *
     * @return Category
     */
    public function addFortuneCooky(\AppBundle\Entity\FortuneCookie $fortuneCooky)
    {
        $this->fortuneCookies[] = $fortuneCooky;
     ...
     * @param \AppBundle\Entity\FortuneCookie $fortuneCooky
     */
    public function removeFortuneCooky(\AppBundle\Entity\FortuneCookie $fortuneCooky)
    {
        $this->fortuneCookies->removeElement($fortuneCooky);
    }
}
